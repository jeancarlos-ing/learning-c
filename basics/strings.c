...
Strings in C are actually arrays of characters, terminated by a C is an advanced subject, fully explained later on, we will use pointers to a character array defined simple strings, in the following manner:

char * name = "John Smith";

This method creates a string which we can only use for reading. If we wishto define a string which can be manipulated, we will need to define it as a local character array:
